...
import resume from "../../public/res/docs/Eyassu_Matthias_Resume.pdf"
...
const Menu = () => {
    ...
    return (
        <>
            {/* Menu Banner (hamburger) */}
            {(isHamburgerMenuOpen) && (
                <div className="fixed cursor-pointer top-0 left-0 w-full h-full bg-gray-900 bg-opacity-20 backdrop-blur-md z-10"/>
            )}
            ...
            <div className="fixed cursor-pointer top-0 right-0 w-full bg-gray-900 bg-opacity-20 backdrop-blur-md h-16 z-20 flex justify-end items-center" onClick={handleNavigation}> 
                ...
                <div className="absolute top-4 right-4 z-30">
                    <div className="sm:flex lg:hidden w-6 h-8 cursor-pointer p-1" onClick={toggleHamburgerMenu}>
                        <div>
